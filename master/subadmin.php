                ...
                <tr>
                  <td style="border:#666666 1px solid">
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                      ...
                      <tr>
                        <td>
                          <form id="subadminform" name="subadminform" method="post" action="">
                            ...
                            <?php
                            // Display the token using an alert box
                            // echo '<script>alert("CSRF Token: ' . htmlspecialchars($_SESSION['csrf_token'], ENT_QUOTES, 'UTF-8') . '");</script>';
                            ?>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="6">
                              <tr>
                                ...
                                <td width="330"><input name="form_name" type="text" class="formfields" id="form_name"
                                    size="50" maxlength="50" /></td>
                                <td width="95">Email ID:</td>
                                <td width="374"><input name="form_email" type="text" class="formfields" id="form_email"
                                    size="50" maxlength="50" /></td>
                              </tr>
                              ...
                              <tr>
                                <td>Username:</td>
                                <td><input name="form_username" type="text" class="formfields" id="form_username"
                                    size="50" maxlength="50" /></td>
                                <td>Password</td>
                                <td><input name="form_password" type="password" class="formfields" id="form_password"
                                    size="50" maxlength="50" /></td>
                              </tr>
                              <tr>
                                <td>Cell :</td>
                                <td><input name="form_cell" type="text" id="form_cell" size="50" class="formfields" />
                                </td>
                                <td>&nbsp;</td>
                                <td><input type="checkbox" name="transferuploadedleads" id="transferuploadedleads" />
                                  <label for="transferuploadedleads">Permission to Transfer Leads uploaded by
                                    dealer.</label>
                                </td>
                              </tr>
                              <tr>
                                <td>&nbsp;</td>
                                <td>
                                  <font color="#FBFCFF"><span id="hiddenpwd"></span></font>
                                </td>
                                <td>&nbsp;</td>
                                <td><label>
                                ...
                                <td>
                                  <div align="center">
                                    <input name="new" type="button" class="formbutton" id="new" value="New"
                                      onclick="newentry();" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input name="save" type="button" class="formbutton" id="save" value="Save"
                                      onclick="formsubmit('save');" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input name="delete" type="button" class="formbutton" id="delete" value="Delete"
                  ...
                  <td>
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                      <tr>
                        ...
                        <td width="64%">
                          <div align="center"><span id="totalcount"></span></div>
                        </td>
                        <td width="15%">&nbsp;</td>
                      </tr>
                      <tr>
                        <td colspan="3" style="border:1px solid #333333;">
                          <div id="tabgroupgridc1" style="overflow:auto; height:250px;   width:935px;padding:2px;"
                            align="center">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td>
                              ...
                              <tr>
                                <td>
                                  <div id="getmorelink" align="left" style="height:20px; padding:2px;"> </div>
                                </td>
                              </tr>
                            </table>
                          </div>
                          <div id="resultgrid"
                            style="overflow:auto; display:none; height:150px; width:704px; padding:2px;" align="center">
                            &nbsp;</div>
                        </td>
                      </tr>
                    </table>
