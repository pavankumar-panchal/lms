...
<body onload="leadgridtab5('1','tabgroupleadgrid','default'),newtog(),updatestatusstrip();">
  ...
  <table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td valign="middle" bgcolor="#D2D8FB" class="contentheader">
        <table width="99%" border="0" align="center" cellpadding="4" cellspacing="0">
          <tr>
            <td>Update Lead
              <?php echo $userslno, $cookie_usertype; ?>
            </td>
          </tr>
        </table>
      </td>
    ...
    <tr>
      <td height="40px" style="background:#FFFFCE">
        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="17%" rowspan="2">
              <font color="#999999" style="font-size:20px">Total:&nbsp;<span id="leadstotal"
                  style="color:#000000"></span></font><br />
              <span onclick="updatestatusstrip();" class="statusstripclass">&nbsp;&nbsp;&nbsp;&nbsp;(Refresh
                Count)</span>
            </td>
            <td width="83%">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="12%" height="20">
                    <div align="right" class="statusstriptextclass"><strong> Not Viewed :</strong></div>
                  </td>
                  <td width="5%">
                    <div align="right"><span id="noviewed"></span></div>
                  </td>
                  <td width="12%">
                    <div align="right" class="statusstriptextclass"><strong>UnAttended :</strong></div>
                  </td>
                  <td width="6%">
                    <div align="right"><span id="unattended"></span></div>
                  </td>
                  <td width="14%">
                    <div align="right" class="statusstriptextclass"><strong>Fake Enquiry :</strong></div>
                  </td>
                  <td width="6%">
                    <div align="right"><span id="notinterested"></span></div>
                  </td>
                  <td width="19%">
                    <div align="right" class="statusstriptextclass"><strong>Not Interested :</strong></div>
                  </td>
                  <td width="6%">
                    <div align="right"><span id="fakeenquiry"></span></div>
                  </td>
                  <td width="15%">
                    <div align="right" class="statusstriptextclass"><strong>Registered User :</strong></div>
                  </td>
                  <td width="5%">
                    <div align="right"><span id="registereduser"></span></div>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td>
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="12%">
                    <div align="right" class="statusstriptextclass"><strong>Attended :</strong></div>
                  </td>
                  <td width="5%">
                    <div align="right"><span id="attended"></span></div>
                  </td>
                  <td width="12%">
                    <div align="right" class="statusstriptextclass"><strong>Demo Given :</strong> </div>
                  </td>
                  <td width="6%">
                    <div align="right"><span id="persuingtopurchase"></span></div>
                  </td>
                  <td width="14%">
                    <div align="right" class="statusstriptextclass"><strong>Quote Sent :</strong></div>
                  </td>
                  <td width="6%">
                    <div align="right"><span id="demogiven"></span></div>
                  </td>
                  <td width="19%">
                    <div align="right" class="statusstriptextclass"><strong>Persuing to Purchase :</strong></div>
                  </td>
                  <td width="6%">
                    <div align="right"><span id="quotesent"></span></div>
                  </td>
                  <td width="15%">
                    <div align="right" class="statusstriptextclass"><strong>Order Closed :</strong></div>
                  </td>
                  <td width="5%">
                    <div align="right"><span id="orderclosed"></span></div>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td colspan="4" valign="top">
              <table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr>
                  <td colspan="4" style="border:solid 1px #999999">
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                      <tr>
                        <td>
                          <table width="100%" border="0" cellspacing="0" cellpadding="6">
                                      ...
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td valign="top" style="border:solid 1px #999999">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                                                <td bgcolor="#0099CC" height="20px"><strong>
                                                    <font color="#FFFFFF">Lead Contact Card</font>
                                                  </strong></td>
                                              </tr>
                                              <tr>
                                                <td valign="top" height="50"><span id="leadisplay">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="1">
                                                      <tr height="30px">
                                                        ...
                                                        <td colspan="2">
                                                          ...
                                                          <input type="hidden" name="hiddencompany"
                                                            id="hiddencompany" />
                                                        </td>
                                                      </tr>
                                                      <tr height="20px">
                                                        <td><strong>Contact person</strong>:<font color="#FF6600">
                                                            <input name="hiddencontact" id="hiddencontact" type="hidden"
                                                              value="" />
                                                          </font>
                                                        </td>
                                                        <td colspan="2">
                                                      ...
                                                      <tr height="20px">
                                                        <td><strong>Address:<font color="#FF6600">
                                                              <input name="hiddenaddress" id="hiddenaddress"
                                                                type="hidden" value="" />
                                                            </font></strong></td>
                                                        <td colspan="2">
                                                          <font color="#FF6600">
                                                      ...
                                                      <tr height="20px">
                                                        <td><strong>District / State</strong>:
                                                          <input type="hidden" name="hiddendistrictstate"
                                                            id="hiddendistrictstate" />
                                                        </td>
                                                        <td colspan="2">
                                                      ...
                                                      <tr height="20px">
                                                        <td><strong>STD Code</strong>:
                                                          <input type="hidden" name="hiddenstdcode"
                                                            id="hiddenstdcode" />
                                                        </td>
                                                        <td colspan="2">
                                                          <font color="#FF6600">
                                                            <input name="stdcode" id="stdcode" type="text"
                                                              autocomplete="off"
                                                              style="width:230px; color:#FF6600;border:1px solid #E1E1E1;" />
                                                          </font>
                                                        </td>
                                                      ...
                                                      <tr height="20px">
                                                        <td><strong>Email ID</strong>:
                                                          <input type="hidden" name="hiddenemailid"
                                                            id="hiddenemailid" />
                                                        </td>
                                                        <td colspan="2">
                                                          <font color="#FF6600">
                                                            <input name="emailid" id="emailid" type="text"
                                                              autocomplete="off"
                                                              style="width:230px;color:#FF6600; border:1px solid #E1E1E1;" />
                                                          </font>
                                                        </td>
                                                      ...
                                                      <tr height="35px">
                                                        <td valign="top"><strong>Reference [Type] :
                                                            <input type="hidden" name="hiddenreference"
                                                              id="hiddenreference" />
                                                          </strong></td>
                                                      ...
                                                      <tr height="20px">
                                                        <td><strong>Given By :
                                                            <input type="hidden" name="hiddengivenby"
                                                              id="hiddengivenby" />
                                                            <input type="hidden" name="hiddengivenbytext"
                                                              id="hiddengivenbytext" />
                                                          </strong></td>
                                                        <td width="212">
                                                          <font color="#FF6600"><span id="givenby1"></span></font>
                                                        </td>
                                                        <td width="20"><span id="help" style="display:none;"><img
                                                              src="../images/help-image.gif"
                                                              onmouseover="tooltip('All')" onMouseout="hidetooltip()"
                                                              class="imageclass" /></span></td>
                                                      </tr>
                                                      <tr height="20px">
                                                        <td><strong>Date of lead:
                                                            <input type="hidden" name="hiddendateoflead"
                                                              id="hiddendateoflead" />
                                                          </strong></td>
                                                        <td colspan="2">
                                                      ...
                                                      <tr height="20px">
                                                        <td><strong>Dealer viewed date:
                                                            <input type="hidden" name="hiddendealerviewdate"
                                                              id="hiddendealerviewdate" />
                                                          </strong></td>
                                                        <td colspan="2">
                                                      ...
                                                      <tr height="20px">
                                                        <td><strong>Product:
                                                            <input type="hidden" name="hiddenproduct"
                                                              id="hiddenproduct" />
                                                          </strong></td>
                                                        <td colspan="2">
                                                      ...
                                                      <?php if (($cookie_usertype == 'Admin') || ($cookie_usertype == 'Sub Admin') || ($cookie_usertype == 'Reporting Authority') || ($cookie_usertype == 'Dealer') || ($cookie_usertype == 'Dealer Member')) { ?>
                                                        <tr height="20px">
                                                          <td><strong>Dealer:
                                                              <input type="hidden" name="hiddendealer"
                                                                id="hiddendealer" />
                                                              <input type="hidden" name="hiddentype" id="hiddentype"
                                                                value="<?php echo ($cookie_usertype); ?>" />
                                                              <input type="hidden" name="hiddendealertext"
                                                                id="hiddendealertext" />
                                                            </strong></td>
                                                          <td>
                                                            <font color="#FF6600"><span id="dealer1"></span></font>
                                                          </td>
                                                          <td><span id="help1" style="display:none;"><img
                                                                src="../images/help-image.gif"
                                                                onMouseover="tooltip('Dealer')" onMouseout="hidetooltip()"
                                                                class="imageclass" /></span></td>
                                                        </tr>
                                                        <tr>
                                                          <td colspan="2" valign="top" height="25px">
                                                            <div id="link" align="center" style="display:none;"><span
                                                                onclick="divopenclosefunction()"
                                                                class="transferleadclass">Transfer this Lead >></span>
                                                            </div>
                                                            <div id="selectlist" style="display:none;" align="left">
                                                              <strong>Transfer To:</strong>&nbsp;&nbsp;&nbsp;
                                                              <select name="dealerlist1" id="dealerlist1"
                                                                style="width:180px">
                                                                <?php echo ($dealerselect1); ?>
                                                              </select>

                                                              &nbsp;&nbsp;<img src="../images/lmsreset-button.jpeg"
                                                                onclick="resetlink('open')"
                                                                class="imageclass" />&nbsp;&nbsp;<img
                                                                src="../images/lmsclose-button.jpeg"
                                                      ...
                                                      if (($cookie_usertype == 'Dealer') && $userslno != '1069') { ?>
                                                        <tr>
                                                          <td colspan="2" valign="top" height="25px">
                                                            <div id="link1" align="center" style="display:none;"><span
                                                                onclick="divopenclosefunction()"
                                                                class="transferleadclass">Assign this Lead >></span></div>
                                                            <div id="selectlist1" style="display:none;" align="left">
                                                              <strong>Transfer To
                                                                Sams:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                              <select name="dealermemberlist" id="dealermemberlist"
                                                                style=" width:180px">
                                                      ...
                                                      <tr height="20px">
                                                        ...
                                                        <td><span id="help2" style="display:none;"><img
                                                              src="../images/help-image.gif"
                                                              onMouseover="tooltip('Manager')" ;
                                                              onMouseout="hidetooltip()" class="imageclass" /></span>
                                                        </td>
                                                      </tr>
                                                      ...
                                                      <!--                                                   
                                                  <tr height="20px">
                                                    <td><strong>GSTIN:</strong>
                                                    <td colspan="2"><font color="#FF6600">
                                                      <input name="gstin" id ="gstin" class="gstin" type="text" autocomplete = "off" style="width:230px;color:#FF6600; border:1px solid #E1E1E1;"/>
                                                      </font></td>
                                                  </tr>  
                                                  ...
                                                  <tr height="20px">
                                                    ...
                                                    <td colspan="2"><font color="#FF6600">
                                                      <input name="product_name" id ="product_name" class="product_name" type="text" autocomplete = "off" style="width:230px;color:#FF6600; border:1px solid #E1E1E1;"/>
                                                      </font></td>
                                                     ...
                                                     <td><strong>Purchase Type:</strong></td>
                                                       <td colspan="2">
                                                        <font color="#FF6600">
                                                            ...
                                                            <select name="purchase_type" id="purchase_type" class="purchase_type" style="width:230px; color:#FF6600; border:1px solid #E1E1E1; ">
                                                             <option value="">Select A Type</option>
                                                               <option value="new">New</option>
                                                              <option value="old">Updation</option>
                                                           </select>
                                                             </font>
                                                             </td>
                                                      ...
                                                      <tr height="20px">
                                                            <td><strong>Usage Type:</strong></td>
                                                             <td colspan="2">
                                                              <font color="#FF6600">
                                                              <select name="usage_type" id="usage_type" class="usage_type" style="width:230px; color:#FF6600; border:1px solid #E1E1E1;">
                                                               <option value="">select A Type</option>
                                                  ...
                                                  <tr height="20px">
                                                    ...
                                                    <td colspan="2"><font color="#FF6600">
                                                      <input name="amount" id ="amount" class="amount" type="number" autocomplete = "off" style="width:210px;color:#FF6600; border:1px solid #E1E1E1;"/>
                                                      </font></td>
                                         
                                                    <td colspan="3">
                                                      <a href="#" class="r-text" style="cursor: pointer;" onclick="addselectedproduct();">Add &gt;&gt;</a>
                                                    </td>
                                             ...
                                             <font color="#FF6600">
                                              ...
                                              <textarea name="remarks" id="remarks" style="width:230px; height:100px; color:#FF6600; border:1px solid #E1E1E1;"></textarea>
                                              </font>
                                            </td> -->
                                              ...
                                              <tr height="20px">
                                                <td colspan="3">
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      <td valign="center" id="messagebox1" width="30%"></td>
                                                      <td valign="top">
                                                        <div align="right">

                                                          <!-- <input type="button" name="quote" id="quote" value="Generate quote" class="formbutton" onclick="" /> -->
                                                          <!-- <input type="button" name="quote" id="quote" value="Generate quote" class="formbutton" onclick="quote_generate();" onclick="quote();" onclick="gstin('gstin');"/> -->

                                                          <input type="button" name="update" id="update" value="Save"
                                                            class="formbutton" onclick="updatedata(); " />
                                                          &nbsp;&nbsp;
                                                          <input name="reset" type="button" value="Reset"
                                                            class="formbutton" onclick="resetform();" />
                                                        </div>
                                                      </td>
                                                    </tr>
                              ...
                              <td valign="top">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="14%" height="20px" valign="top">
                                      <div id="tarckerdiv" class="leadtrackerdivclass" onclick="leadtrack('tracker')">
                                        Lead Tracker</div>
                                    </td>
                                    <td width="7%" height="20px" valign="top">
                                      <div align="center">|</div>
                                    </td>
                                    <td width="17%" height="20px" valign="top">
                                      <div id="productchange" class="leadtrackerdivclass"
                                        onclick="leadtrack('productchange')">Change Product</div>
                                    </td>
                                    <td width="6%" height="20px" valign="top"><!--<div align="center" >|</div>--></td>
                                    <td width="14%" valign="top">
                                      <!--<div id="sendsmsdiv" class="leadtrackerdivclass" onclick="leadtrack('sendsms')">Send SMS</div>-->
                                    </td>
                                    <td width="17%"><strong>
                                        <div id="displayrowcount" align="right"></div>
                                      </strong></td>
                                    <td width="4%" align="right"><img src="../images/first.jpg" alt="First"
                                        title="First" onclick="getnextorpreviousvalue('first')"
                                        style="cursor:pointer" /></td>
                                    <td width="5%" align="right"><img src="../images/previous.jpg"
                                        onclick="getnextorpreviousvalue('previous')" style="cursor:pointer"
                                        title="Previous" alt="Previous" /></td>
                                    <td width="4%" align="left"><input type="hidden" name="hiddentypepn"
                                        id="hiddentypepn" value="" /><input type="hidden" name="hiddenleadcount"
                                        id="hiddenleadcount" value="" />&nbsp;</td>
                                    <td width="5%" align="left"><img src="../images/next.jpg"
                                        onclick="getnextorpreviousvalue('next')" style="cursor:pointer" title="Next"
                                        alt="Next" /></td>
                                    <td width="6%" align="left"><img src="../images/last.jpg" alt="Last" title="Last"
                                        onclick="getnextorpreviousvalue('last')" style="cursor:pointer" /></td>
                                  </tr>
                                  <tr>
                                    <td colspan="12" valign="top">
                                      <div id="tracker" style="display:block;">
                                        <table width="100%" cellspacing="0" cellpadding="1"
                                          style="border:solid 1px #999999">
                                          <tr>
                                            <td colspan="5" bgcolor="#0099CC" height="20px"><strong>
                                                <font color="#FFFFFF">Lead Tracker</font>
                                              </strong></td>
                                          </tr>
                                          <tr height="20px">
                                            <td width="17%" align="center" id="tabgroupgridh1"
                                              onclick="gridtab5('1','tabgroupgrid','followup'); " style="cursor:pointer"
                                              class="grid-active-tabclass">Follow Up</td>
                                            <td width="20%" align="center" id="tabgroupgridh2"
                                              onclick="gridtab5('2','tabgroupgrid','updatelogs');"
                                              style="cursor:pointer" class="grid-tabclass">Update Logs</td>
                                            <td width="20%" align="center" id="tabgroupgridh3"
                                              onclick="gridtab5('3','tabgroupgrid','transferlogs');"
                                              style="cursor:pointer" class="grid-tabclass">Transfer Logs</td>
                                            <td width="21%" align="center" id="tabgroupgridh4"
                                              onclick="gridtab5('4','tabgroupgrid','viewotherleads');"
                                              style="cursor:pointer" class="grid-tabclass">Matching Leads</td>
                                            <td width="22%" align="center" id="tabgroupgridh5"
                                              onclick="gridtab5('5','tabgroupgrid','downloadlogs');"
                                              style="cursor:pointer" class="grid-tabclass">Download Logs</td>
                                          </tr>
                                          <tr>
                                            <td colspan="5" valign="top">
                                              <table width="100%" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  <td valign="top" height="364px">
                                                    <div id="tabgroupgridc1" style="display:block;">
                                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                          <td valign="top">
                                                            <table width="100%" border="0" cellspacing="0"
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td colspan="2" valign="top"><textarea
                                                                    name="form_leadremarks" rows="2" class="formfields"
                                                                    style="padding:2px; width:400px; font-family:Arial, Helvetica, sans-serif; font-size:12px"
                                                                    id="form_leadremarks"></textarea>
                                                                  <input type="hidden" name="hiddenactivetype"
                                                                    id="hiddenactivetype" value="followup" />
                                                                </td>
                                                              </tr>
                                                              <tr>
                                                                <td valign="top">Next Followup Date:</td>
                                                                <td width="20%" valign="top">
                                                                  <input name="followupdate" type="text"
                                                                    class="formfields" id="DPC_followupdate" size="20"
                                                                    maxlength="10" value="" readonly="readonly" />
                                                                </td>
                                                                <td width="20%" valign="top">
                                                                  <div align="center"
                                                                    style="display: flex; justify-content: space-around;">
                                                                    <input type="time" name="followuptime"
                                                                      id="DPC_followuptime" class="formfields" />
                                                                    <input style="height: 20px; margin: 0 5px;"
                                                                      name="newfollowup" type="button"
                                                                      class="formbutton" id="newfollowup" value="New"
                                                                      onclick="newfollowup();" />
                                                                    <input style="height: 20px; margin: 0 5px;"
                                                                      name="addfollowup" type="button"
                                                                      class="formbutton" id="addfollowup"
                                                                      value="Add &gt;&gt;" onclick="addfollowup();" />
                                                                  </div>
                                                                </td>
                                                              </tr>
                                                            </table>
                                                        ...
                                                        <tr>
                                                          <td height="20px" valign="top"><span
                                                              id="followupmessage"></span></td>
                                                        </tr>
                                                        <tr>
                                                          <td valign="top">
                                                            <table width="100%" border="0" cellspacing="0"
                                                    ...
                                                    <div id="tabgroupgridc2" style="display:none;">
                                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                          <td colspan="3">
                                                            <div id="tabgroupgridc11"
                                                              style="overflow:auto; height:320px; width:550px"
                                                              align="center">
                                                              <table width="100%" border="0" cellspacing="0"
                                                                cellpadding="0">
                                                                <tr>
                                                                  <td>
                                                                    <div id="tabgroupgridc1_2" align="center">
                                                                      <table width="100%" border="0" cellspacing="0"
                                                                        cellpadding="0" id="gridtable1">
                                                                ...
                                                                <tr>
                                                                  <td>
                                                                    <div id="getmorelink2" align="left"
                                                            ...
                                                            <div id="resultgrid2"
                                                              style="overflow:auto; display:none; height:300px; width:550px;"
                                                              align="center">&nbsp;</div>
                                                          </td>
                                                        </tr>
                                                      </table>
                                                    ...
                                                    <div id="tabgroupgridc3" style="display:none;">
                                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                          <td colspan="3">
                                                            <div id="tabgroupgridc12"
                                                              style="overflow:auto; height:310px; width:550px"
                                                              align="center">
                                                              <table width="100%" border="0" cellspacing="0"
                                                                cellpadding="0">
                                                                <tr>
                                                                  <td>
                                                                    <div id="tabgroupgridc1_3" align="center">
                                                                      <table width="100%" border="0" cellspacing="0"
                                                                        cellpadding="0" id="gridtable1">
                                                                        <tr class="gridheader" height="20px">
                                                                          <td class="tdborder1">&nbsp;Sl No</td>
                                                                ...
                                                                <tr>
                                                                  <td>
                                                                    <div id="getmorelink3" align="left"
                                                                      style="height:20px; "></div>
                                                                  </td>
                                                                </tr>
                                                              </table>
                                                          ...
                                                          <td colspan="3">
                                                            <div id="tabgroupgridc14"
                                                              ...
                                                              <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                  <td>
                                                                    <div id="tabgroupgridc1_4" align="center">
                                                                      <table width="100%" border="0" cellspacing="0"
                                                                        cellpadding="0" id="gridtable1">
                                                                        <tr class="gridheader" height="20px">
                                                                          <td class="tdborder1">&nbsp;Sl No</td>
                                                                ...
                                                                <tr>
                                                                  <td>
                                                                    <div id="getmorelink4" align="left"
                                                                      style="height:20px; "></div>
                                                                  </td>
                                                                </tr>
                                                              </table>
                                                          ...
                                                          <td colspan="3">
                                                            <div id="tabgroupgridc15"
                                                              ...
                                                              <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                  <td>
                                                                    <div id="tabgroupgridc1_5" align="center">
                                                                      <table width="100%" border="0" cellspacing="0"
                                                                        cellpadding="0" id="gridtable1">
                                                                        <tr class="gridheader" height="20px">
                                                                          <td class="tdborder1">&nbsp;Sl No</td>
                                                                ...
                                                                <tr>
                                                                  <td>
                                                                    <div id="getmorelink5" align="left"
                                                                      style="height:20px; "></div>
                                                                  </td>
                                                                </tr>
                                                              </table>
                                            ...
                                            <tr>
                                              <td>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="2"
                                                  style="border:solid 1px #999999">
                                                  <tr>
                                                    <td bgcolor="#0099CC" height="17px"><strong>
                                                        <font color="#FFFFFF">Change Product by adding as a new Lead
                                                        </font>
                                                      </strong></td>
                                                  </tr>
                                                  <tr>
                                                    <td>
                                                      <table width="100%" border="0" cellspacing="0">
                                                        <tr>
                                                          <td colspan="2">
                                                            <div align="justify">
                                                              <font color="#FF6666"><strong>Note :</strong> </font>This
                                                              provision will create/upload a &quot;New Lead&quot; under
                                                              you name for a different product selected. Please note,
                                                              existing lead remains as it is, without any changes. If
                                                              existing lead is not interested, please update the same.
                                                              You can access such new lead created, by separately
                                                              locating it.
                                                            </div>
                                                          </td>
                                                        </tr>
                                                        <tr>
                                                          <td width="27%" height="30px"><strong>Company :</strong>
                                                            <input type="hidden" name="hiddennewleadcompany"
                                                              id="hiddennewleadcompany" />
                                                          </td>
                                                          <td width="73%" height="30px"><span
                                                              id="newleadcompany"></span></td>
                                                        </tr>
                                                        <tr>
                                                          <td><strong>Contact person :</strong></td>
                                                          <td><input type="text" name="newleadcontactperson"
                                                              id="newleadcontactperson" class="formfields1" />
                                                            <input type="hidden" name="hiddennewleadcontact"
                                                              id="hiddennewleadcontact" />
                                                          </td>
                                                        </tr>
                                                        <tr>
                                                          <td><strong>Cell :</strong></td>
                                                          <td><input type="text" name="newleadcell" id="newleadcell"
                                                              class="formfields1" />
                                                            <input type="hidden" name="hiddennewleadcell"
                                                              id="hiddennewleadcell" />
                                                          </td>
                                                        </tr>
                                                        <tr>
                                                          <td><strong>Email Id :</strong></td>
                                                          <td><input type="text" name="newleademailid"
                                                              id="newleademailid" class="formfields1" />
                                                            <input name="hiddennewleademailid" id="hiddennewleademailid"
                                                              type="hidden" />
                                                          </td>
                                                        </tr>
                                                        <tr>
                                                          <td width="31%">
                                                            <font color="#FF6666"><strong>Product :</strong></font>
                                                          </td>
                                                          <td width="69%"><label>
                                                              <select name="productchangeselect"
                                                                id="productchangeselect" class="formfields1"
                                                                style="border:1px solid #FF6666">
                                                                <?php
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td><select name="newleadsource" class="formfields1"
                                                              id="newleadsource">
                                                              ...
                                                              <option value="NSDL/Income Tax website">NSDL/Income Tax
                                                                website</option>
                                                              <option value="Reference from customer">Reference from
                                                                customer</option>
                                                              <option value="Relyon Representative">Relyon
                                                                Representative</option>
                                                              <option value="Web Search/Search Engine">Web Search/Search
                                                                Engine</option>
                                                              <option value="Incoming Email with clear reqt">Incoming
                                                                Email with clear reqt</option>
                                                              <option value="Incoming Call">Incoming Call</option>
                                                              <option value="Others">Others</option>
                                                            </select>
                                                            <input type="hidden" name="hiddennewleadsource"
                                                              id="hiddennewleadsource" />
                                                          </td>
                                                        </tr>
                                                        <tr>
                                                          <td valign="top"><strong>Remarks :</strong></td>
                                                          <td><textarea name="leadremarks1" rows="4" class="formfields"
                                                              style="padding:2px; width:400px; font-family:Arial, Helvetica, sans-serif; font-size:12px;border:1px thin #000000;"
                                                              id="leadremarks1"></textarea></td>
                                                        </tr>
                                                        <tr>
                                                          <td><strong>Dealer :</strong></td>
                                                          <td><label>
                                                              <input type="radio" name="dealerselection" id="samedealer"
                                                                value="samedealer" checked="checked"
                                                                onclick="togdealerselect();" />
                                                              Same Dealer</label>
                                                            <label>
                                                              <input type="radio" name="dealerselection"
                                                                id="aspermapping" value="aspermapping"
                                                                onclick="togdealerselect();" />
                                                              As per Mapping</label>
                                                            <label>
                                                              <input type="radio" name="dealerselection"
                                                                id="manualselection" value="manualselection"
                                                                onclick="togdealerselect();" />
                                                        ...
                                                        <tr>
                                                          <td>&nbsp;</td>
                                                          <td height="25px">
                                                            <div id="dealerlistdiv" style="display:none;">
                                                              <select name="changeproductdealerlist"
                                                                id="changeproductdealerlist" style="width:50%">
                                                                <?php echo ($dealerselect1); ?>
                                                              </select>
                                                            </div>
                                                          </td>
                                                        ...
                                                        <tr>
                                                          <td colspan="2">
                                                            <table width="100%" border="0" cellspacing="0"
                                                              cellpadding="0">
                                                              <tr>
                                                                <td width="68%" height="25" id="errordisplay">&nbsp;
                                                                </td>
                                                                <td width="32%" align="right"><input type="button"
                                                                    name="create" id="create" value="Create Lead"
                                                                    class="formbutton" onclick="createlead();" />
                                                                  &nbsp;&nbsp;
                                                                  <input type="button" name="resetbutton"
                                                                    id="resetbutton" value="Reset" class="formbutton"
                                                                    onclick="resetproductchange();" />
                                                                </td>
                                                              </tr>
                                                            </table>
                                                          </td>
                            ...
                            <form id="quoteForm" action="" method="post">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                style="margin-top: 10px; height: 200px; overflow-y: auto; margin-top:20px;">
                                        ...
                                        <td valign="top" style="border:solid 1px #999999">
                                          <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                            <tr>
                                              <td bgcolor="#0099CC">
                                                <strong>
                                                  <font color="#FFFFFF">Send Quote</font>
                                                </strong>
                                              </td>
                                            </tr>
                                            <tr>
                                              <td valign="top" height="100px">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                                  ...
                                                  <tr>
                                                    <td colspan="3">
                                                      <div style="display:; border: 1px solid #999; " align="justify"
                                                        id="tabg1c2">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="2"
                                                          class="productcontent" height="150px">
                                                          <tr>
                                                            <td colspan="2" valign="top">
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0"
                                                                      ...
                                                                      <tr>
                                                                        <td>
                                                                          <table width="100%" border="0" cellspacing="0"
                                                                            cellpadding="5"
                                                                            style="color:#646464; font-weight:bold">
                                                                            <tr>
                                                                              <td width="2%">&nbsp;</td>
                                                                              <td width="16%">
                                                                              ...
                                                                              <td width="16%">
                                                                                <div align="center">Purchase Type</div>
                                                                              </td>
                                                                              <td width="18%">
                                                                                <div align="center">Usage Type</div>
                                                                              </td>
                                                                              <td width="15%">
                                                                      ...
                                                                      <tr>
                                                                        <td>
                                                                          <table width="100%" border="0" cellspacing="0"
                                                                            cellpadding="3" id="adddescriptionrows">
                                                                            <tr id="removedescriptionrow1">
                                                                              <td width="5%">
                                                                                <div align="left"><strong>1</strong>
                                                                                </div>
                                                                              </td>
                                                                              <td width="11%">
                                                                                <div align="center">
                                                                                  <input name="productName[]"
                                                                                    ...
                                                                                    class="swifttext type_enter focus_redclass"
                                                                                    style="width:115px" maxlength="70"
                                                                                    autocomplete="off" />
                                                                                </div>
                                                                              </td>
                                                                              <td width="16%">
                                                                                <div align="center">
                                                                                  <select name="purchaseType[]"
                                                                                    id="purchaseType"
                                                                                    style="width:110px"
                                                                                    class="swiftselect-mandatory type_enter focus_redclass"
                                                                                    id="selectiontype1">
                                                                                    <option value=""
                                                                                      selected="selected">--Select--
                                                                                    </option>
                                                                                    <option value="New">New</option>
                                                                                    <option value="Updation">Updation
                                                                                    </option>
                                                                                  </select>
                                                                                </div>
                                                                              </td>
                                                                              <td width="18%">
                                                                                <div align="center">
                                                                                  <select name="usageType[]"
                                                                                    id="usageType" style="width:110px"
                                                                                    class="swiftselect-mandatory type_enter focus_redclass"
                                                                                    id="selectiontype2">
                                                                                    <option value=""
                                                                                      selected="selected">--Select--
                                                                                    </option>
                                                                                    <option value="Single User">Single
                                                                                      User</option>
                                                                                    <option value="Multi User">Multi
                                                                                      User</option>
                                                                                  </select>
                                                                                </div>
                                                                              </td>
                                                                              ...
                                                                              <td width="8%">
                                                                                <font color="#FF0000"><strong><a
                                                                                      id="removerowdiv1"
                                                                                      onclick="removedescriptionrows('removedescriptionrow1','1')"
                                                                                      style="cursor:pointer;">X</a></strong>
                                                                                </font>
                                                                      ...
                                                                      <tr>
                                                                        <td>
                                                                          <div align="left" id="adddescriptionrowdiv">
                                                                            <div align="right"><a
                                                                                onclick="adddescriptionrows();"
                                                                                style="cursor:pointer"
                                                                                class="r-text">Add one More >></a></div>
                                                                          </div>
                                                                        </td>
                                                                      </tr>
                                                                    </table>
                                                  ...
                                                  <!-- Row for GSTIN and Remarks -->
                                                  <tr>
                                                    <td colspan="2" style="vertical-align: top; width: 50%; ">
                                                      <label for="gstin">GSTIN:</label>
                                                      <input type="text" id="gstin" name="gstin" class="formfields"
                                                  ...
                                                  <tr>
                                                    <td colspan="3" style="vertical-align: top; ">
                                                      ...
                                                      <textarea name="remarks" id="remarks" rows="2" class="formfields"
                                                        style="padding:2px; width:260px; font-family:Arial, Helvetica, sans-serif; font-size:12px; margin-top:10px;"></textarea>
                                                    </td>
                                                  </tr>
                                                  ...
                                                  <tr>
                                                    <td colspan="3" style="text-align:center;">
                                                      ...
                                                      <!-- <button name="generated" type="button" class="formbutton"
                                                        id="generated" onclick="generate_pdf();">Generate
                                                        PDF</button> -->

                                                    </td>
                                                  </tr>
                                                  <td valign="" id="messagebox2" style="width: 300px;"></td>
                                      ...
                                      <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                        <tr>
                                          <td bgcolor="#0099CC"><strong>
                                              <font color="#FFFFFF">Lead Status</font>
                                            </strong></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                              <tr>
                                                <td valign="top" colspan="2"><strong>Initial Remarks :
                                                    <div id="showeditimage" style="display:none;" align="left"><img
                                                        src="../images/edit1.png" height="16" onclick="opentoedit();"
...
<div style="display:none;position:absolute; opacity:0.9;" id="hoverimage" onclick="opentoedit();"><img src="../images/LMS-edithover.jpg"  /></div>-->
                                                    <input type="hidden" name="hiddenleadremarks"
                                                      id="hiddenleadremarks" />
                                                  </strong></td>
                                                <td width="33%" valign="top">
                                                  <div id="leadremarks">
                                                    <font color="#FF6600">-Select a lead-</font>
                                                  </div>
                                                  <div id="leadremarksbox" style="display:none;">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="1">
                                                      <tr>
                                                        <td width="84%"><textarea name="editleadremarks"
                                                            id="editleadremarks" rows="2" class="formfields"
                                                            style="padding:2px; width:260px; font-family:Arial, Helvetica, sans-serif; font-size:12px"></textarea>
                                                        </td>
                                                        <td width="16%">
                                                          <div><img src="../images/lmsreset-button.jpeg"
                                                              onclick="closeopentxtbox('open')" class="imageclass" />
                                                          </div>

                                                          <div><img src="../images/lmsclose-button.jpeg"
                                                              onclick="closeopentxtbox('close')" class="imageclass" />
                                                          </div>
                                                        </td>
                                                      </tr>
                                                    </table>
                                                ...
                                                <td width="31%" valign="top"><select name="form_leadstatus"
                                                    id="form_leadstatus" class="formfields">
                                                    ...
                                                    <option value="Requirement Does not Meet">Requirement Does not Meet
                                                    </option>
                                                  </select>
                                                  <br><br>
                                                  <select name="form_subleadstatus" id="form_subleadstatus"
                                                    class="formfields" style="display: none">
                                                    <option value="" selected="selected">--- Select Status ---</option>
                                                    <option value="Need PMS and HRMS">Need PMS and HRMS</option>
                                                    <option value="Need Cloud based Solution">Need Cloud based Solution
                                                    </option>
                                                    <option value="Requirement does not match">Requirement does not
                                                      match</option>
                                                    <option value="Need Payroll with T&A">Need Payroll with T&A</option>
                                                    <option value="Pricing Issue">Pricing Issue</option>
                                                    <option value="Executive not handled on-time">Executive not handled
                                                      on-time</option>
                                                    <option value="Other">Other</option>
                                                  </select><br><br>
                                                  <textarea name='leadMeetRemarks' id='leadMeetRemarks'
                                                    placeholder='Enter Remarks' style="display: none"></textarea>
                                                  <br><br>

                                                  <input name="save" type="button" class="formbutton" id="save"
                                                    value="Update" onclick="formsubmit('save');" />
                                                </td>
                                              </tr>
                                            </table>
                                          </td>
          ...
          <tr>
            <td colspan="4" style="color:#000000;border:solid 1px #999999">
              <table width="100%" border="0" cellspacing="0" cellpadding="2">
                <tr>
                  <td bgcolor="#DEE1FA"><strong>Filter: </strong>[<a style="cursor:pointer"
                      onclick="newtog();">Show/Hide</a>]</td>
                </tr>
                <tr>
                  <td>
                    <form id="filterform" name="filterform" onsubmit="return false;" autocomplete="off" method="post"
                      action="filteredtoexcel.php">
                      <div id="divform">
                        <table width="100%" border="0" cellspacing="0" cellpadding="2" style="background-color:#ffffcc">
                          <tr>
                            <td>&nbsp;<strong>Search</strong>:
                              <input name="searchcriteria" type="text" class="formfields" id="searchcriteria" size="30"
                                maxlength="30" />
                              <font style="font-size:10px;" color="#666666">(Leave Empty for all)</font>
                              <input type="hidden" name="srchhiddenfield" id="srchhiddenfield" />
                            </td>
                                ...
                                <tr>
                                  <td><strong>Search For:</strong>
                                    ...
                                    <label>
                                      ...
                                      Manager Name</label>
                                    <input name="datatypehiddenfield" id="datatypehiddenfield" type="hidden" />
                                  </td>
                                </tr>
                              </table>
                            </td>
                            ...
                            <td colspan="4">
                              <table width="100%" border="0" cellspacing="0" cellpadding="4"
                                ...
                                <tr>
                                  ...
                                  <td width="37%"><input name="fromdate" type="text" class="formfields"
                                      id="DPC_fromdate" size="20" maxlength="10" value="<?php echo ($date); ?>"
                                      style="width:50%" />
                                    <input type="hidden" name="hiddenfromdate" id="hiddenfromdate" />
                                  </td>
                                  <td width="13%">To Date : </td>
                                  <td width="39%"><input name="todate" type="text" class="formfields" id="DPC_todate"
                                      size="20" maxlength="10" value="<?php echo ($defaulttodate); ?>"
                                      style="width:50%" />
                                ...
                                <tr>
                                  ...
                                  <td width="37%"><select name="productid" class="formfields" id="productid"
                                    ...
                                    <input type="hidden" name="hiddengrouplabel" id="hiddengrouplabel" />
                                  </td>
                                  ...
                                  <td width="39%"><select name="dealerid" class="formfields" id="dealerid"
                                    ...
                                    <input type="hidden" name="hiddendealerid" id="hiddendealerid" />
                                  </td>
                                </tr>
                                <tr>
                                  <td>Given By : </td>
                                  <td width="37%"><select name="givenby" class="formfields" id="givenby"
                                      style="width:50%">
                                      <?php
                                      echo ($givenselect);
                                      ?>
                                    </select>
                                    <input type="hidden" name="hiddengivenby1" id="hiddengivenby1" />
                                  </td>
                                  <td width="13%">Status of Lead :</td>
                                  <td width="39%"><select name="leadstatus" class="formfields" id="leadstatus"
                                      style="width:50%">
                                      <?php
                                      echo ($leadstatusselect);
                                      ?>
                                    </select>
                                    <input type="hidden" name="hiddenleadstatus" id="hiddenleadstatus" />
                                  </td>
                                </tr>
                                <tr>
                                  <td width="13%">Sub Status of Lead :</td>
                                  <td width="39%">
                                    <select name="leadsubstatus" class="formfields" id="leadsubstatus"
                                      style="width:50%">
                                      <?php
                                      echo ($leadsubstatusselect);
                                      ?>
                                    </select>
                                    <input type="hidden" name="hiddenleadsubstatus" id="hiddenleadsubstatus" />
                                  </td>
                                </tr>
                                <tr>
                                  <td colspan="2"><input name="dropterminatedstatus" type="checkbox"
                                      id="dropterminatedstatus" value="true" checked="checked" />
                                    <label for="dropterminatedstatus">Do not consider Order Closed / Fake / Exsting
                                      Users / Not Interested</label>
                                  </td>
                                  <td>Lead Source:</td>
                                  <td><select name="form_source" class="formfields" id="form_source" style="width:50%">
                                      <?php echo ($referenceselect); ?>
                                    </select>
                                    <input type="hidden" name="hiddensource" id="hiddensource" />
                                  </td>
                                </tr>
                              </table>
                            </td>
                          ...
                          <tr>
                            <td colspan="4">
                              <table width="100%" border="0" cellspacing="0" cellpadding="4">
                                <tr>
                                  <td width="48%">&nbsp;
                                    <input name="considerfollowup" type="checkbox" id="considerfollowup"
                                      onclick="filterfollowupdates();" />
                                    <label for="considerfollowup">Consider Follow Ups</label>
                                  </td>
                                  <td width="52%">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="34%"><label>
                                            <input type="radio" name="followup" id="followuppending"
                                              value="followuppending" checked="checked" disabled="disabled" />
                                            Follow Up Pending</label></td>
                                        <td width="66%"><label>
                                            <input type="radio" name="followup" id="followupmade" value="followupmade"
                                              disabled="disabled" />
                          ...
                          <tr>
                            <td colspan="4">
                              <table width="100%" border="0" cellspacing="0" cellpadding="4">
                                <tr>
                                  <td width="11%">From Date : </td>
                                  <td width="37%"><input name="filter_followupdate1" type="text" class="formfields"
                                      id="DPC_filter_followupdate1" size="20" maxlength="10"
                                      value="<?php echo ($defaulttodate); ?>" disabled="disabled" style="width:50%" />
                                    <input name="filter_followupdate1hdn" type="hidden" class="formfields"
                                      id="filter_followupdate1hdn" value="" />
                                  </td>

                                  <td width="13%">To Date : </td>
                                  <td width="39%"><input name="filter_followupdate2" type="text" class="formfields"
                                      id="DPC_filter_followupdate2" size="20" maxlength="10"
                                      value="<?php echo ($defaulttodate); ?>" disabled="disabled" style="width:50%" />
                                    <input name="filter_followupdate2hdn" type="hidden" class="formfields"
                                      id="filter_followupdate2hdn" value="" />
                                  </td>
                                </tr>
                                <tr>
                                  <td>Entered By :</td>
                                  <td><select name="followedby" id="followedby" style="width:50%" disabled="disabled">
                                    ...
                                    <input name="followedbyhidden" id="followedbyhidden" type="hidden" />
                                  </td>
                                  <td>Remarks :</td>
                          ...
                          <tr>
                            ...
                            <td colspan="2">
                              <div align="center">
                                <input name="view" type="button" class="formbutton" id="view" value="Show"
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input name="excel" type="button" class="formbutton" id="resetform" value="Reset"
                                  onclick="filtering('resetform');" />
                              </div>
                            </td>
                          </tr>
                        </table>
          ...
          <tr>
            <td>
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="141" id="tabgroupleadgridh1" onclick="leadgridtab5('1','tabgroupleadgrid','default'); "
                    class="grid-active-leadtabclass">Recent Leads</td>
                  <td width="3"></td>
                  <td width="141" id="tabgroupleadgridh2" onclick="leadgridtab5('2','tabgroupleadgrid','notviewed'); "
                    class="grid-leadtabclass">Leads Not Viewed!</td>
                  <td width="3"></td>
                  <td width="141" id="tabgroupleadgridh3"
                    onclick="leadgridtab5('3','tabgroupleadgrid','todayfollowup'); " class="grid-leadtabclass">Follow
                    Ups Due</td>
                  <td width="3"></td>
                  <td width="141" id="tabgroupleadgridh4" onclick="leadgridtab5('4','tabgroupleadgrid','nofollowup'); "
                    class="grid-leadtabclass">Zero Follow Ups !</td>
                  <td width="3"></td>
                  <td width="141" id="tabgroupleadgridh5"
                    onclick="leadgridtab5('5','tabgroupleadgrid','searchresult'); " class="grid-leadtabclass">Search
                    Result</td>
                  <td width="141"></td>
                  <td width="94"></td>
                </tr>
    ...
    <tr>
      <td height="20px" colspan="4">
        <form id="toexcelform" name="toexcelform" action="" method="post">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0"
              ...
              <tr class="headerline">
                ...
                <td width="86%" align="left">
                  <div id="followupsduetoexcel" align="left">( <a style="cursor:pointer;"
                      onclick="gridtoexcel('notviewed')" class="headerclass"><strong>Export to Excel</strong></a> )
                  </div>
                </td>
              </tr>
              <tr>
                <td colspan="3">
                  <div id="tabgroupgridnv1" style="overflow:auto; height:260px; width:945px" align="center">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td>
                          <div id="tabgroupgridnv1_1" align="center">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr class="gridheader" height="20px">
                      ...
                      <tr>
                        <td>
                          <div id="getmorelinknv1" align="left" style="height:20px; "> </div>
                        </td>
                      </tr>
                    </table>
                  </div>
                  <div id="resultgridnv1" style="overflow:auto; display:none; height:150px; width:700px;"
                    align="center">&nbsp;</div>
                </td>
              </tr>
          ...
          <div id="tabgroupleadgridc3" style="display:none;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0"
              ...
              <tr class="headerline">
                ...
                <td align="left">
                  <div id="followupsduetoexcel" align="left">( <a style="cursor:pointer;"
                      onclick="gridtoexcel('followupdue')" class="headerclass"><strong>Export to Excel</strong></a> )
                  </div>
                </td>
              </tr>
              <tr>
                      ...
                      <td colspan="3">
                        <div id="tabgroupgridfup1" style="overflow:auto; height:260px; width:947px" align="center">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td>
                                <div id="tabgroupgridfup1_1" align="center">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr class="gridheader">
                                      <td class="tdborderlead">&nbsp;Sl No</td>
                                      <td class="tdborderlead">&nbsp;Lead Id</td>
          ...
          <div id="tabgroupleadgridc4" style="display:none;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0"
              ...
              <tr class="headerline">
                <td width="14%">
                  <div id="followuptotaln">&nbsp;</div>
                </td>
                <td width="15%" align="left">
                  <div id="toexcellink" align="left">( <a style="cursor:pointer;" onclick="gridtoexcel('zerofollowup')"
                      class="headerclass"><strong>Export to Excel</strong></a> )</div>
                </td>
                <td width="71%" align="left">&nbsp;</td>
              </tr>
              <tr>
                <td colspan="4">
                  <div id="tabgroupgridn1" style="overflow:auto; height:260px; width:945px" align="center">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td>
                          <div id="tabgroupgridn1_1" align="center">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr class="gridheader" height="20px">
                                <td class="tdborderlead">&nbsp;Sl No</td>
                                <td class="tdborderlead">&nbsp;Lead Id</td>
                      ...
                      <tr>
                        <td>
                          <div id="getmorelinkn1" align="left" style="height:20px; "> </div>
                        </td>
                      </tr>
                    </table>
                  </div>
                  <div id="resultgridn1" style="overflow:auto; display:none; height:150px; width:700px;" align="center">
                    &nbsp;</div>
                </td>
              </tr>
            </table>
          ...
          <div id="tabgroupleadgridc5" style="display:none;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0"
              ...
              <tr>
                <td colspan="3">
                  <div id="tabgroupgridf1" style="overflow:auto; height:260px; width:945px" align="center">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td>
                          <div id="tabgroupgridf1_1" align="center">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr class="gridheader" height="20px">
                                <td class="tdborderlead">&nbsp;Sl No</td>
                                <td class="tdborderlead">&nbsp;Lead Id</td>
                      ...
                      <tr>
                        <td>
                          <div id="getmorelinkf1" align="left" style="height:20px; "> </div>
                        </td>
                      </tr>
                    </table>
                  </div>
                  <div id="resultgridf1" style="overflow:auto; display:none; height:150px; width:700px;" align="center">
                    &nbsp;</div>
                </td>
              </tr>
            </table>
